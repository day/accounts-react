...
class SignUp extends Component {
  ...
  onSubmit = () => {
    ...
    if (logUserMetaData && Meteor.settings.public.userMetaData) {
      newUser.metaData = Meteor.settings.public.userMetaData
    }

    if (enableFileStack && Meteor.settings.public.userFileStack) {
      newUser.fileStack = Meteor.settings.public.userFileStack
    }
